...
/**
 * REST controller for managing {@link ar.com.guanaco.diucon.domain.Categoria}.
 */
@RestController
@RequestMapping("/api")
public class CategoriaResource {
    ...
    public ResponseEntity<List<CategoriaDTO>> getAllCategorias(CategoriaCriteria criteria) {
        log.debug("REST request to get Categorias by criteria: {}", criteria);
        List<CategoriaDTO> entityList = categoriaQueryService.findByCriteria(criteria);
