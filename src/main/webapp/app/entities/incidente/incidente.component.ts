...
export class IncidenteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.incidenteService
      ...
      .subscribe(
        (res: HttpResponse<IIncidente[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInIncidentes(): void {
    this.eventSubscriber = this.eventManager.subscribe('incidenteListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IIncidente[] | null, headers: HttpHeaders, page: number): void {
